...
ActiveRecord::Schema.define(version: 20170224070600) do
  ...
  create_table "attach_books", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["book_id", "created_at"], name: "index_attach_books_on_book_id_and_created_at"
    t.index ["book_id"], name: "index_attach_books_on_book_id"
  end
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.index ["publisher_id", "created_at"], name: "index_books_on_publisher_id_and_created_at"
